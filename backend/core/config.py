...
# Gemini 3.x models "think" by default, spending the output budget on hidden
# reasoning tokens — that silently truncated the Artist's JSON+SVG mid-string.
# Setting the thinking level to LOW keeps latency and truncation down while
# leaving a little reasoning headroom. Valid: MINIMAL, LOW, MEDIUM, HIGH.
GEMINI_THINKING_LEVEL: str = os.environ.get("GEMINI_THINKING_LEVEL", "MINIMAL")
