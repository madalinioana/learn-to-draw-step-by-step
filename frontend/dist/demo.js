...
const DEMO_PROMPTS = [
  ...
  // ── 1. a hot air balloon — envelope, mouth, ropes, basket; burner and panel lines added on refinement.
  {
  ...
  <g fill="none" stroke="#1a1a1a" stroke-linecap="round" stroke-linejoin="round">
    <path id="step-1" d="M 253.3 102.5 C 160.9 98.1 143.7 252.6 176.8 298.6 C 201.8 321.9 313.8 318.4 335.9 296.8 C 372.2 247.4 347.9 97.9 260.3 101.6 Z" stroke-width="1.75"/>
    <path id="step-2" d="M 184.3 296.4 Q 252.6 321.7 332.7 298.9" stroke-width="1.75"/>
    <path id="step-3" d="M 198.7 312.6 L 207.7 320.7 213.1 342.7 226.7 358.6 229.0 373.7 M 310.8 309.6 L 302.2 322.4 297.0 338.8 290.9 352.1 284.8 372.0" stroke-width="1.75"/>
    <path id="step-4" d="M 225.5 367.5 L 247.5 369.4 267.2 365.8 286.1 368.2 L 283.7 388.7 283.4 401.9 289.9 423.8 L 271.0 420.9 250.5 423.2 241.5 419.4 216.4 420.9 Z" stroke-width="1.75"/>
  </g>
</svg>`,
  ...
  <g fill="none" stroke="#1a1a1a" stroke-linecap="round" stroke-linejoin="round">
    ...
    <path id="step-3" d="M 198.7 312.6 L 207.7 320.7 213.1 342.7 226.7 358.6 229.0 373.7 M 310.8 309.6 L 302.2 322.4 297.0 338.8 290.9 352.1 284.8 372.0" stroke-width="1.75"/>
    <path id="step-4" d="M 225.5 367.5 L 247.5 369.4 267.2 365.8 286.1 368.2 L 283.7 388.7 283.4 401.9 289.9 423.8 L 271.0 420.9 250.5 423.2 241.5 419.4 216.4 420.9 Z" stroke-width="1.75"/>
    <path id="step-5" d="M 245.5 323.2 L 266.4 320.8 L 267.6 334.2 L 244.3 336.4 Z" stroke-width="1.75"/>
    <path id="step-6" d="M 257.6 320.4 L 254.3 313.8" stroke-width="1.75"/>
  </g>
</svg>`,
  ...
  <g fill="none" stroke="#1a1a1a" stroke-linecap="round" stroke-linejoin="round">
    ...
    <path id="step-5" d="M 245.5 323.2 L 266.4 320.8 L 267.6 334.2 L 244.3 336.4 Z" stroke-width="1.75"/>
    <path id="step-6" d="M 257.6 320.4 L 254.3 313.8" stroke-width="1.75"/>
    <path id="step-7" d="M 206.3 127.7 Q 217.0 202.7 212.0 296.8 M 256.5 100.9 L 258.0 152.8 254.3 198.7 256.7 245.3 253.9 293.8 M 305.7 128.5 Q 292.2 203.0 302.9 297.9" stroke-width="1.75"/>
  </g>
</svg>`,
  ...
  // ── 2. a flower — stem, center, four petals; leaves added on the refinement pass.
  {
    prompt: "a flower",
    iterations: [
      {
        svg: `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" width="512" height="512">
  <g fill="none" stroke="#1a1a1a" stroke-linecap="round" stroke-linejoin="round">
    <path id="step-1" d="M 254.4 450.4 C 259.9 346.8 237.5 302.9 254.9 218.5" stroke-width="1.75"/>
    <path id="step-2" d="M 241.5 203.8 A 14.7 20.4 0 1 0 267.7 203.1 A 19.2 19.1 0 1 0 240.6 200.4" stroke-width="1.75"/>
    <path id="step-3" d="M 254.4 185.6 Q 281.3 126.5 256.5 109.3 Q 236.0 132.2 256.2 181.1" stroke-width="1.75"/>
    <path id="step-4" d="M 255.6 213.9 Q 279.5 268.4 259.3 292.4 Q 232.3 272.5 252.9 214.4" stroke-width="1.75"/>
    <path id="step-5" d="M 236.7 199.1 Q 187.7 177.0 173.6 197.0 Q 186.7 222.3 243.5 200.0" stroke-width="1.75"/>
    <path id="step-6" d="M 271.5 197.0 Q 323.2 180.0 337.2 202.7 Q 321.3 215.5 270.5 197.9" stroke-width="1.75"/>
  </g>
</svg>`,
  ...
  <g fill="none" stroke="#1a1a1a" stroke-linecap="round" stroke-linejoin="round">
    ...
    <path id="step-5" d="M 236.7 199.1 Q 187.7 177.0 173.6 197.0 Q 186.7 222.3 243.5 200.0" stroke-width="1.75"/>
    <path id="step-6" d="M 271.5 197.0 Q 323.2 180.0 337.2 202.7 Q 321.3 215.5 270.5 197.9" stroke-width="1.75"/>
    <path id="step-7" d="M 254.4 351.3 Q 209.6 340.7 210.9 311.1 Q 254.0 309.2 255.0 351.6" stroke-width="1.75"/>
    <path id="step-8" d="M 256.4 380.0 Q 300.6 369.6 298.8 339.8 Q 255.6 339.0 254.4 379.3" stroke-width="1.75"/>
  </g>
</svg>`,
  ...
  // ── 3. an owl on a branch — body and head first, then beak, wings, talons.
  {
    ...
    iterations: [
      {
        svg: `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" width="512" height="512">
  <g fill="none" stroke="#1a1a1a" stroke-linecap="round" stroke-linejoin="round">
    <path id="step-1" d="M 202.3 375.9 C 158.7 376.2 158.0 183.4 253.9 176.1 C 356.4 176.6 348.1 377.4 315.4 383.5" stroke-width="1.75"/>
    <path id="step-2" d="M 232.2 240.3 A 10.7 18.0 0 1 1 228.1 268.7 A 18.9 10.6 0 1 1 230.6 240.7" stroke-width="1.75"/>
    <path id="step-3" d="M 279.1 239.1 A 18.5 14.8 0 1 1 279.5 267.3 A 16.2 16.6 0 1 1 283.7 241.1" stroke-width="1.75"/>
    <path id="step-4" d="M 99.9 420.3 Q 255.0 382.3 413.0 420.4" stroke-width="1.75"/>
  </g>
</svg>`,
  ...
  <g fill="none" stroke="#1a1a1a" stroke-linecap="round" stroke-linejoin="round">
    ...
    <path id="step-3" d="M 279.1 239.1 A 18.5 14.8 0 1 1 279.5 267.3 A 16.2 16.6 0 1 1 283.7 241.1" stroke-width="1.75"/>
    <path id="step-4" d="M 99.9 420.3 Q 255.0 382.3 413.0 420.4" stroke-width="1.75"/>
    <path id="step-5" d="M 253.8 254.0 L 258.5 274.3 L 263.3 256.7" stroke-width="1.75"/>
  </g>
</svg>`,
  ...
  <g fill="none" stroke="#1a1a1a" stroke-linecap="round" stroke-linejoin="round">
    ...
    <path id="step-4" d="M 99.9 420.3 Q 255.0 382.3 413.0 420.4" stroke-width="1.75"/>
    <path id="step-5" d="M 253.8 254.0 L 258.5 274.3 L 263.3 256.7" stroke-width="1.75"/>
    <path id="step-6" d="M 198.6 237.4 Q 150.0 304.1 213.5 363.9" stroke-width="1.75"/>
    <path id="step-7" d="M 309.8 238.7 Q 358.6 299.8 299.1 356.9" stroke-width="1.75"/>
  </g>
</svg>`,
  ...
  <g fill="none" stroke="#1a1a1a" stroke-linecap="round" stroke-linejoin="round">
    ...
    <path id="step-6" d="M 198.6 237.4 Q 150.0 304.1 213.5 363.9" stroke-width="1.75"/>
    <path id="step-7" d="M 309.8 238.7 Q 358.6 299.8 299.1 356.9" stroke-width="1.75"/>
    <path id="step-8" d="M 224.4 384.1 q -5.2 14.1 3.7 13.1 M 233.2 385.9 q 7.5 12.4 -6.0 9.7" stroke-width="1.75"/>
    <path id="step-9" d="M 278.6 381.9 q -6.3 15.9 0.5 13.7 M 288.3 382.2 q 6.6 8.7 -5.0 11.4" stroke-width="1.75"/>
  </g>
</svg>`,
